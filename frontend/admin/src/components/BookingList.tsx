...
const getStatusColor = (status: string | number) => {
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-red-600">Nie udało się pobrać listy rezerwacji. Spróbuj ponownie.</p>
          </div>
        </div>
      </div>
    )
  ...
  if (!data || data.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">Nie ma jeszcze żadnych rezerwacji w tym warsztacie.</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Lista rezerwacji</h2>
